...
msbuild /m /p:Configuration=Release,Platform=x64,WholeProgramOptimization=PGInstrument /t:LibLinkOnly /consoleLoggerParameters:Summary /verbosity:minimal /fileLogger /fileLoggerParameters:Summary;Append;Verbosity=normal;LogFile=%~dp0build\lame_x64_2017.log lame_dll.vcxproj
@if %errorlevel% neq 0 goto errorexit
...
msbuild /m /p:Configuration=Release,Platform=x64,WholeProgramOptimization=PGOptimize,LinkTimeCodeGeneration=PGOptimization /t:LibLinkOnly /consoleLoggerParameters:Summary /verbosity:minimal /fileLogger /fileLoggerParameters:Summary;Append;Verbosity=normal;LogFile=%~dp0build\lame_x64_2017.log lame_dll.vcxproj
@if %errorlevel% neq 0 goto errorexit
...
msbuild /m /p:Configuration=Release,Platform=Win32,WholeProgramOptimization=PGInstrument /t:LibLinkOnly /consoleLoggerParameters:Summary /verbosity:minimal /fileLogger /fileLoggerParameters:Summary;Append;Verbosity=normal;LogFile=%~dp0build\lame_Win32_2017.log lame_dll.vcxproj
@if %errorlevel% neq 0 goto errorexit
